...
SCENARIOS = [
    {
        "id": "1_baseline_20m",
        "name": "1. Baseline LAN (H.264, 20M, Static)",
        "codec": "H.264",
        "bitrate": "20000",
        "motion": False,
        "net_delay": None,
    ...
    {
        "id": "2_low_bitrate_5m",
        "name": "2. Low Bitrate (H.264, 5M, Static)",
        "codec": "H.264",
        "bitrate": "5000",
        "motion": False,
        "net_delay": None,
    ...
    {
        "id": "3_high_bitrate_50m",
        "name": "3. High Bitrate (H.264, 50M, Static)",
        "codec": "H.264",
        "bitrate": "50000",
        "motion": False,
        "net_delay": None,
    ...
    {
        "id": "4_high_motion_glxgears",
        "name": "4. High Motion (H.264, 20M, glxgears)",
        "codec": "H.264",
        "bitrate": "20000",
        "motion": True,
        "net_delay": None,
    ...
    {
        "id": "5_netem_delay_15ms",
        "name": "5. Jitter & Delay (+15ms ± 3ms)",
        "codec": "H.264",
        "bitrate": "20000",
        "motion": False,
        "net_delay": "15ms 3ms",
    ...
    {
        "id": "6_netem_delay_30ms",
        "name": "6. Jitter & Delay (+30ms ± 5ms)",
        "codec": "H.264",
        "bitrate": "20000",
        "motion": False,
        "net_delay": "30ms 5ms",
    ...
    {
        "id": "7_netem_loss_2pct",
        "name": "7. Packet Loss (2% Loss)",
        "codec": "H.264",
        "bitrate": "20000",
        "motion": False,
        "net_delay": None,
    ...
    {
        "id": "8_netem_loss_5pct",
        "name": "8. Packet Loss (5% Loss)",
        "codec": "H.264",
        "bitrate": "20000",
        "motion": False,
        "net_delay": None,
    ...
    {
        "id": "9_congested_matrix",
        "name": "9. Congested (+15ms, 2% Loss, glxgears)",
        "codec": "H.264",
        "bitrate": "20000",
        "motion": True,
        "net_delay": "15ms 3ms",
...
def set_conditions(sc):
    ...
    if net_cmds:
        subprocess.run(["ssh", f"cyc@{HOST_IP}", "; ".join(net_cmds)], check=False)
        time.sleep(1)
...
with open("/tmp/benchmark_final_matrix.json", "w") as f:
